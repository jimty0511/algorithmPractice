...
public class Polygon2D {
    ...
    public boolean containsTwo(double var1, double var3) {
        if (this.npoints > 2) {
            int var5 = 0;
            double var6 = this.xpoints[this.npoints - 1];
            double var7 = this.ypoints[this.npoints - 1];

            for (int var10 = 0; var10 < this.npoints; ++var10) {
                double var8 = this.xpoints[var10];
                double var9 = this.ypoints[var10];
                if (var9 != var7) {
                    label78:
                    {
                        double var11;
